    ...
    return (
        <div className="page-main faqPage">
            <div className="faqHeaders m-padding">
                <hr className="hr"/>
                <h1 className="blue bolder font-24 m-40">FAQ’s</h1>
                <h2 className="blue-60 font-18">Frequently Asked Questions</h2>
            </div>
                ...
                {Array.from(Array(5).keys()).map((el, i) => (
                    <Accordion key={i} expanded={expanded === i} onChange={handleChange(i)}>
                        <AccordionSummary
                            ...
                            id="panel1a-header"
                        >
                            <h1 className="bold font-20">Accordion {i + 1}</h1>
                        </AccordionSummary>
                        <AccordionDetails>
                            <p className="blue font-18">
