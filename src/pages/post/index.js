                        ...
                        <div className='leftPart'>
                            ...
                            <div className='bottomPart'>
                                ...
                                <div className='shareBlock'>
                                    ...
                                    <span className="icon-Facebbok-Icon blue font-30 shareTo"></span>
                                    <span className="icon-Twiter-Icon blue font-30 shareTo"></span>
                                    <span className="icon-Linkedin-Icon blue font-30 shareTo"></span>
                                </div>
                            </div>
                        </div>
                        <GetQuote/>
