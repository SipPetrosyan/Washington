...
const Pricing = () => {
    return (
        <div className='pricingBlock'>
            <h1 className='font-32 blue'>Pricing</h1>
            ...
            <p className='font-24 blue bolder'>
            ...
            <div className="btn">
                <Button>
                    <span className="icon-Operator-icon-1 font-32"><span className="path1"></span><span
                        className="path2"></span><span className="path3"></span></span>
                    <a className='font-20 bold'>( 202 ) 930 - 8005</a>
                </Button>
            </div>
        </div>
    );
