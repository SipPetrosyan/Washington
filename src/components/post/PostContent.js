    ...
    return (
        <div className='postContent'>
            <div className='postTopic'>
                <h1 className='font-36 blue bolder postTitle'>Ram Looks To Change The Market With Brand New Electric Pickup</h1>
                <p className='font-24 blue-60 bold postDesc'>
                ...
                <h2 className='font-32 blue bold postSubTitle'>So what is the word on it so far?</h2>
                <p className='font-24 blue-60 bold postDesc'>
